...
class TestAbandonedUploadSweeper:
    ...
    def test_marks_stale_pending_models_failed_and_deletes_object(self):
        ...
        with patch("app.tasks.maintenance.get_sync_engine", return_value=mock_engine), \
             patch("app.tasks.maintenance.update_model_status") as mock_update_status, \
             patch("app.tasks.scan._delete_s3_object") as mock_delete:
            from app.tasks.maintenance import cleanup_abandoned_uploads
